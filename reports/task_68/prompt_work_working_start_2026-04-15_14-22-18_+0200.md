...
- working
  - ✅ Created zenoh-jni-runtime subproject with primitive-only JNI adapters. Moved Zen [ctx_rec_26]
    ...
    - [ ] Step 14: Update Zenoh.kt (scouting) and Liveliness.kt and Querier.kt to use runt [ctx_rec_24]
    - [ ] Step 15: Build and verify - run gradlew build/test to ensure everything compiles [ctx_rec_25]
- reviewing
