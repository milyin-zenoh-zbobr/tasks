...
1. Read the task description shown in the prompt (the `When starting the stage store the last commit's sha as "from" in stage context record. 
...
# Current task: show comments belonging to stage
...
# Work branch: zbobr_fix-76-show-comments-belonging-to-stage
