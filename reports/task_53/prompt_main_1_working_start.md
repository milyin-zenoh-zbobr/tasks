...
- planning
  - ✅ Plan approved and checklist created. 5 implementation steps: C bridge additions, [ctx_rec_10]
    - [ ] Add Transport and Link C bridge types and callbacks to zenoh_cgo.h/c [ctx_rec_5]
    - [ ] Implement Transport type in zenoh/transport.go [ctx_rec_6]
    - [ ] Implement Link type in zenoh/link.go [ctx_rec_7]
    - [ ] Create connectivity test suite in tests/connectivity_test.go [ctx_rec_8]
    - [ ] Extend z_info example with connectivity API output [ctx_rec_9]
