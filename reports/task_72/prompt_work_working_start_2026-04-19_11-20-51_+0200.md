...
- working
    ...
    - [ ] Phase 3c: Adapt Session.kt (largest adaptation - inline domain-to-primitive conv [ctx_rec_23]
    - [ ] Phase 3c: Adapt Publisher.kt, AdvancedPublisher.kt, AdvancedSubscriber.kt [ctx_rec_24]
    - [ ] Phase 3c: Adapt Query.kt, Querier.kt, Scout in Zenoh.kt [ctx_rec_25]
    - [ ] Phase 3d: Adapt JNILiveliness.kt (keep file, replace external funs with runtime [ctx_rec_26]
    - [ ] Phase 3e: Update drop-in compatible domain classes (Subscriber, Queryable, Livel [ctx_rec_27]
    - [ ] Phase 4: Remove all Rust code (delete zenoh-jni/ directory and rust-toolchain.to [ctx_rec_28]
    - [ ] Phase 5: Update examples/build.gradle.kts (remove Cargo task and java.library.pa [ctx_rec_29]
    - [ ] Phase 6: Update CI workflows (ci.yml, publish-jvm.yml, publish-android.yml) [ctx_rec_30]
- working
